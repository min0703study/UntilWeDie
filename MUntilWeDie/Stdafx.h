...
#define MON_NORMAL_SEARCH_RANGE_Y	70
#define MON_NORMAL_ATTACK_RANGE_X	200
#define MON_NORMAL_ATTACK_RANGE_Y	70
#define MON_NORMAL_COLL_RANGE_X		80
#define MON_NORMAL_COLL_RANGE_Y		70
