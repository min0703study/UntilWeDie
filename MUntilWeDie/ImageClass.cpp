...
HRESULT ImageClass::init(void)
{
	...
	//ijh - Monster
	IMAGEMANAGER->addFrameImage(MONSTER_NORMAL_IDLE, "Resources/Images/Monster/monster_normal_idle.bmp", 800, 600, 8, 6);
	IMAGEMANAGER->addFrameImage(MONSTER_NORMAL_WALK, "Resources/Images/Monster/monster_normal_walk.bmp", 800, 600, 8, 6);
	IMAGEMANAGER->addFrameImage(MONSTER_NORMAL_ATTACK, "Resources/Images/Monster/monster_normal_attack.bmp", 1100, 200, 11, 2);
	IMAGEMANAGER->addFrameImage(MONSTER_NORMAL_DEATH, "Resources/Images/Monster/monster_normal_death.bmp", 1200, 200, 12, 2);
	IMAGEMANAGER->addFrameImage(MONSTER_NORMAL_FALL, "Resources/Images/Monster/monster_normal_fall.bmp", 500, 200, 5, 2);
